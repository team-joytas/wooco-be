package kr.wooco.woocobe.api.calendar.group

import kr.wooco.woocobe.api.calendar.group.request.CreateGroupRequest
import kr.wooco.woocobe.api.calendar.group.request.JoinGroupRequest
import kr.wooco.woocobe.api.calendar.group.request.UpdateGroupInfoRequest
import kr.wooco.woocobe.api.calendar.group.response.CreateGroupResponse
import kr.wooco.woocobe.api.calendar.group.response.GenerateInviteCodeResponse
import kr.wooco.woocobe.api.calendar.group.response.GroupDetailResponse
...
class GroupController(
    ...
    override fun readGroup(
        ...
        return ResponseEntity.ok().body(GroupDetailResponse.Companion.from(result))
    }
    ...
    override fun readAllGroup(
        ...
        return ResponseEntity.ok().body(GroupDetailResponse.Companion.listFrom(results))
    }
}
