package kr.wooco.woocobe.api.calendar.schedule

import kr.wooco.woocobe.api.calendar.schedule.request.CreatePlanRequest
import kr.wooco.woocobe.api.calendar.schedule.request.UpdatePlanInfoRequest
import kr.wooco.woocobe.api.calendar.schedule.response.CreatePlanResponse
import kr.wooco.woocobe.api.calendar.schedule.response.PlanDetailResponse
...
class SchedulePlanController(
    ...
    override fun readPlan(
        ...
        return ResponseEntity.ok().body(PlanDetailResponse.Companion.from(result))
    }
}
