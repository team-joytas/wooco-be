...
import kr.wooco.woocobe.core.schedule.application.port.out.SchedulePlanCommandPort
...
import kr.wooco.woocobe.core.schedule.domain.exception.NotExistsPlanException
import kr.wooco.woocobe.mysql.schedule.entity.SchedulePlanPlaceJpaEntity
import kr.wooco.woocobe.mysql.schedule.repository.SchedulePlanJpaRepository
import kr.wooco.woocobe.mysql.schedule.repository.SchedulePlanPlaceJpaRepository
...
internal class ScheduleScheduleSchedulePlanPersistenceAdapter(
    ...
    private fun saveNew(plan: Plan): Long {
        ...
        val planPlaceJpaEntities = SchedulePlanPlaceJpaEntity.listOf(plan = plan, planJpaEntity = planJpaEntity)
