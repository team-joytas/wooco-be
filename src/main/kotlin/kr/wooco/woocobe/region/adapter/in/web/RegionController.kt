package kr.wooco.woocobe.region.adapter.`in`.web

import kr.wooco.woocobe.region.adapter.`in`.web.request.CreatePreferenceRegionRequest
import kr.wooco.woocobe.region.adapter.`in`.web.response.CreatePreferenceRegionResponse
import kr.wooco.woocobe.region.adapter.`in`.web.response.PreferenceDetailResponse
import kr.wooco.woocobe.region.application.command.port.`in`.AddPreferenceRegionUseCase
import kr.wooco.woocobe.region.application.command.port.`in`.DeletePreferenceRegionCommand
import kr.wooco.woocobe.region.application.command.port.`in`.DeletePreferenceRegionUseCase
import kr.wooco.woocobe.region.application.query.port.`in`.GetAllPreferenceRegionQuery
import kr.wooco.woocobe.region.application.query.port.`in`.GetAllPreferenceRegionUseCase
import kr.wooco.woocobe.region.application.query.port.`in`.GetPreferenceRegionQuery
import kr.wooco.woocobe.region.application.query.port.`in`.GetPreferenceRegionUseCase
